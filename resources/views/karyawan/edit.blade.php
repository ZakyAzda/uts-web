...
<div class="max-w-4xl mx-auto mt-8 p-6 bg-white shadow-lg rounded-lg">
    <h1 class="text-3xl font-semibold text-gray-900 mb-6">Edit Data Karyawan</h1>
    ...
    <form action="{{ route('karyawan.update', $karyawan->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="id" id="id"
                   class="mt-1 p-3 block w-full border {{ $errors->has('id') ? 'border-red-500' : 'border-gray-300' }} rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-gray-100"
                   value="{{ old('id', $karyawan->id) }}" readonly>
            @error('id')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="bidang_keahlian" id="bidang_keahlian"
                   class="mt-1 p-3 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                   value="{{ old('bidang_keahlian', $karyawan->bidang_keahlian) }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_mulai" id="tanggal_mulai"
                   class="mt-1 p-3 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                   value="{{ old('tanggal_mulai', $karyawan->tanggal_mulai) }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="durasi_kontrak" id="durasi_kontrak"
                   class="mt-1 p-3 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                   value="{{ old('durasi_kontrak', $karyawan->durasi_kontrak) }}" required>
        </div>

        <div class="mb-4">
            <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
            <select name="status" id="status"
                    class="mt-1 p-3 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
        ...
        <div class="flex justify-between items-center mt-6">
            <button type="submit"
                    class="px-6 py-3 bg-blue-600 text-white font-medium text-lg rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                Update
            </button>
            <a href="{{ route('karyawan.index') }}"
               class="px-6 py-3 bg-gray-300 text-gray-700 font-medium text-lg rounded-lg hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300">
                Batal
            </a>
        </div>
    </form>
